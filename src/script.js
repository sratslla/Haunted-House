...
// Ghost
const ghost1 = new THREE.PointLight('#ff00ff', .5, 2)
const ghost2 = new THREE.PointLight('#00ffff', .5, 2)
const ghost3 = new THREE.PointLight('#ffff00', .5, 2)
